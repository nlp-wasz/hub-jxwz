...
# 加载排序模型
# modelscope download --model BAAI/bge-reranker-base --local_dir task01/models/BAAI/bge-reranker-base
tokenizer = AutoTokenizer.from_pretrained('../task01/models/BAAI/bge-reranker-base/')
rerank_model = AutoModelForSequenceClassification.from_pretrained('../task01/models/BAAI/bge-reranker-base/')
# rerank_model.cuda()
rerank_model.eval()

# 进行召回合并
bge = json.load(open('submit_bge_sgement_retrieval_top10.json', 'r', encoding='utf-8'))
bm25 = json.load(open('submit_bm25_retrieval_top10.json', 'r', encoding='utf-8'))
