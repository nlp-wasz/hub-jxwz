...
#             in_dim = hidden_dim
#
#         layers.append(nn.Linear(in_dim, output_dim))  # 最后一层输出
...
#     [128],  # 1层，128节点
#     [128, 64],  # 2层，128、64节点
#     [128, 64, 32],  # 3层，128、64、32节点
#     [256, 128, 64, 32],  # 4层，256、128、64、32节点
# ]
#
#
# # 训练并记录loss
# def train_and_evaluate(hidden_dims, model, dataloader, criterion, optimizer, num_epochs=10):
#     losses = []
...
#     print(f"\nTraining model with layers: {hidden_dims}")
#     model = SimpleClassifier(vocab_size, hidden_dims, len(label_to_index))
...
#
#     # 训练模型
#     losses = train_and_evaluate(hidden_dims, model, dataloader, criterion, optimizer)
#     results[tuple(hidden_dims)] = losses
#
# # 输出不同模型的损失变化
# for hidden_dims, losses in results.items():
#     print(f"\nLoss for model with layers {hidden_dims}:")
#     print(losses)
